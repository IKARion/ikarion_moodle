...
##Pioneer v1.4.6
* Fixed CSS issue with Topic Editing dropdown

##Pioneer v1.4.5
* Fixed CSS issue with Topic Editing dropdown

##Pioneer v1.4.4
* Fixed CSS issue with top navigation and padding
* Marketing spot will be hidden if no title is set
* Added 3 more marketing spots to the top area for a total of six
* Added 6 new marketing spots in the main frontpage textbox area
* Added Top Marketing Spots to login.php layout file.  This is the default Moodle login page.
* Added background color for User Grades Overview page
* Dock background color now uses the block border color
* Docked blocks now use block background color
...
* Increased limits for featured courses and course sliders.  A hard limit of 28 was used but is not recommended.  This was done to accommodate My Courses and set a limit for how many Personalized Recommended Courses would appear in sliders.
