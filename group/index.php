...
switch ($action) {
    ...
    case 'showselectgrouptasksform':
        ...
        break;
    case 'showgrouptaskmappingform':
        redirect(new moodle_url('/group/group_task_mapping.php', array('courseid' => $courseid)));
        break;

    // Ikarion Group Task End
...
// Ikarion Group Task Mapping

echo '<p><input type="submit" name="act_showgrouptaskmappingform" id="showgrouptaskmapping" value="'
    . get_string('grouptaskmappingedit', 'group') . '" /></p>' . "\n";
