...
/// find out current groups mode
    ...
    // New! Enable seperate group forums in single threaded mode. Course managers should see all group discussions, but
    // regular participants should only see the discussion of their most recent group.
...
/// Print settings and things across the top
    ...
    if ($forum->type == 'single') {
        $discussion = NULL;
        // New! Display only the discussion of the most recent group of a user.
...
//            $usergroup = groups_get_most_recent_user_group($USER->id, $cm->course);
        ...
        $discussions = $DB->get_records('forum_discussions', array('forum'=>$forum->id, 'groupid'=>$currentgroup), 'timemodified ASC');
