...
$strings = json_encode(get_string('conceptnetwork', 'wiki'), JSON_UNESCAPED_UNICODE);

//switch the PHP-variables $concepts and $strings to an Javascript-variable.
echo ("<script type=\"text/javascript\">var concepts = $concepts, strings = $strings; </script> ");
