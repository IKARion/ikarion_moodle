...
function hvp_cm_info_view(cm_info $cm) {
    ...
    if ($USER->editing != 1) {
        $link = '<iframe src="' . $CFG->httpswwwroot . '/mod/hvp/embed.php?id=' . $cm->id . '" width="800px" height="511px" frameborder="0" allowfullscreen="allowfullscreen"></iframe><script src="' . $CFG->httpswwwroot . '/mod/hvp/library/js/h5p-resizer.js" charset="UTF-8"></script>';
        $cm->set_content($link);
    }
}
