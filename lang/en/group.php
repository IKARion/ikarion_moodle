...
// New GroupAL
$string['groupal'] = 'GroupAL';
$string['lang'] = 'Language';
$string['country'] = 'Country';
$string['forum'] = 'Forum Posts';
$string['grades'] = 'Quiz Grades';
$string['assignments'] = 'Assignments Grades';
$string['file'] = 'CSV Upload';
$string['heterogen'] = 'Heterogeneous';
$string['homogen'] = 'Homogeneous';
$string['disabled'] = 'Disabled';
$string['csv'] = 'GroupAL - CSV Import';
$string['weight'] = 'Weight';
$string['continue'] = 'Continue';
$string['optimization'] = 'Number of optimizations';
$string['delimiter'] = 'Delimiter';
$string['cohort'] = 'Cohort';
$string['activity'] = 'Moodle Activity';
$string['pi'] = 'PerformanceIndex of';
$string['gpi'] = 'GroupPerformanceIndex of';
$string['kpi'] = 'CohortPerformanceIndex of';
