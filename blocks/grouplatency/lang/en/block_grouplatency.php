...
$string['configdesc_curl_url'] = 'Server url for curl call';
$string['configlabel_curl_port'] = 'CURL Port';
$string['configdesc_curl_port'] = 'CURL Port';
$string['configlabel_secret_token'] = 'Secret Token';
$string['configdesc_secret_token'] = 'Secret token for authentication';
$string['configlabel_intervall'] = 'Poll Interval';
$string['configdesc_intervall'] = 'Polling Interval to XPS';
...
$string['noactivity'] = 'Derzeit gibt es keine neuen Hinweise zur Forenaktivität eurer Gruppe.';
