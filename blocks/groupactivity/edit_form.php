...
class block_groupactivity_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        /*
        // Level 0
        $mform->addElement('text', 'config_level_0', get_string('level_0', 'block_groupactivity'));
        $mform->setDefault('config_level_0', 0.33);
        $mform->setType('config_level_0', PARAM_TEXT);

        $mform->addElement('textarea', 'config_level_0_text', get_string('level_0_text', 'block_groupactivity'));
        $mform->setType('config_level_0_text', PARAM_RAW);

        // Level 1
        $mform->addElement('text', 'config_level_1', get_string('level_1', 'block_groupactivity'));
        $mform->setDefault('config_level_1', 0.66);
        $mform->setType('config_level_1', PARAM_TEXT);

        $mform->addElement('textarea', 'config_level_1_text', get_string('level_1_text', 'block_groupactivity'));
        $mform->setType('config_level_1_text', PARAM_RAW);

        // Level 2
        $mform->addElement('text', 'config_level_2', get_string('level_2', 'block_groupactivity'));
        $mform->setDefault('config_level_2', 1);
        $mform->setType('config_level_2', PARAM_TEXT);

        $mform->addElement('textarea', 'config_level_2_text', get_string('level_2_text', 'block_groupactivity'));
        ...
        */
        ...
        $mform->addElement('select', 'config_mirroring', get_string('mirroring', 'block_groupactivity'), $groupings);
        $mform->addElement('select', 'config_guiding', get_string('guiding', 'block_groupactivity'), $groupings);
        $mform->addElement('select', 'config_mirroring_guiding', get_string('mirroring_guiding', 'block_groupactivity'),
            $groupings);
        $mform->addElement('select', 'config_nothing', get_string('nothing', 'block_groupactivity'), $groupings);
        */
    }
}