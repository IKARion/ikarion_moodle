...
$string['ikarionconsent:addinstance'] = 'Add a new ikarionconsent block';
$string['ikarionconsent:myaddinstance'] = 'Add a new ikarionconsent block to Dashboard';
$string['pluginname'] = 'Einwilligungserklärung';
